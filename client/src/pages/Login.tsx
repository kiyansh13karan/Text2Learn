...
import { BookOpen, AlertCircle, Github, Mail, Lock } from 'lucide-react'
      ...
      <div className="relative z-10 w-full max-w-md animate-scaleIn">
        <div className="gradient-border rounded-2xl p-8"
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm" style={{ color: 'var(--text-muted)' }}>Sign in to continue learning</p>
          </div>
          ...
          <p className="text-center mt-6 text-sm" style={{ color: 'var(--text-muted)' }}>
            ...
            <Link to="/signup" className="font-medium transition-colors" style={{ color: 'var(--primary)' }}>
              Sign up
            </Link>
          </p>
        </div>
